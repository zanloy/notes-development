(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://zanloy.github.io/notes-development/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://zanloy.github.io/notes-development/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://zanloy.github.io/notes-development/assets/css/just-the-docs-' + theme + ".css"
      );
    };
